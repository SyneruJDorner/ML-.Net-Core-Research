...
namespace ML_Dot_Net_Core_ResearchML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Justin\source\repos\ML-Dot-Net-Core_Research\ML-Dot-Net-Core_Research\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../ML_Dot_Net_Core_ResearchML.Model/MLModel.zip";
